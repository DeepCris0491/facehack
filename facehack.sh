...
echo -e "${blue}
 ...
 |   _] |  _  |/   \_ |   [_ |  |  ||  _  |/   \_ |     Y
 |  T   |  |  |\     ||     T|  |  ||  |  |\     ||  .  |
 l__j   l__j__j \____jl_____jl__j__jl__j__j \_version 2.0" | lolcat; tput civis
...
function agregado(){
  ...
  ${colours["yellow"]}[${colours["red"]}++${colours["yellow"]}]${colours["green"]} Descripcion =>${colours["white"]} ${url1}
  ${colours["yellow"]}[${colours["red"]}++${colours["yellow"]}]${colours["green"]} Imagen =>${colours["white"]} ${url2}
  ${colours["red"]}[${colours["red"]}++${colours["red"]}]${colours["green"]} URL personalizada =>${colours["white"]} ${url4}
...
function imagenpagina(){
	clear
	echo -e "\nIngrese la ruta o el nombre de la imagen a agrefan como fondo de degradado.\nLa imagen debe estar en carpeta carpeta de \$HOME/facehack/files\n"
